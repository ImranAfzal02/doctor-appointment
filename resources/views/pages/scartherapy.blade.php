...
@section('content')
<p class="services-heading-1 mt-3 mb-3">MEDICAL TATTOOING AND SCAR THERAPY</p>
<p><span class="sub-heading-bold">3D nipple tattooing: </span>3D nipple tattooing is a type of medical tattooing that recreates the appearance of the nipple and areola on the reconstructed breast after a mastectomy or nipple removal. It uses specialized pigments and techniques to create a realistic 3D effect. It can be done as a standalone procedure or after nipple reconstruction.</p>
